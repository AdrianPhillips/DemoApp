...
//  ZombieConga
//
//  Created by Adrian's Laptop on 4/9/14.
...
- (void)update:(NSTimeInterval)currentTime
{
    ...
    if (_lives <= 0 && !_gameOver) {
        ...
        [[GameOverScene alloc] initWithSize:self.size won11:NO];
        // 2
        SKTransition *reveal =
...
- (void)moveTrain
{
    ...
    if (trainCount >= 8 && !_gameOver) {
        ...
        // 1
        SKScene * gameOverScene =
        [[GameOverScene alloc] initWithSize:self.size won11:YES];
        // 2
        SKTransition *reveal =
        [SKTransition flipHorizontalWithDuration:0.5];
        // 3
